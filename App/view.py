...
def thread_cycle():
    while True:
        ...
        if int(inputs[0]) == 1:
            ...
            max = controller.findInterLandingPoints(cont)
            print("La cantidad total de cables conectados a los landing points dados son:", max[1])
            print("Esta fue la lista de landing points:", 'max[0]')
